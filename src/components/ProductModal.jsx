...
//     window.open(`https://wa.me/8928460224?text=${encodeURIComponent(msg)}`, '_blank');
//   };
...
//             {/* SECOND BUTTON */}
//             <button
//               onClick={buyOnWhatsApp2}
//               className="w-full bg-[#1a73e8] text-white py-4 flex items-center justify-center gap-4 font-bold uppercase hover:bg-green-600 transition-all shadow-lg"
//             >
